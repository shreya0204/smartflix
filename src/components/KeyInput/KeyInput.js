        ...
        <div className="flex justify-center">
            <div className="w-10/12 mt-32 bg-gray-500 rounded-lg bg-opacity-50">
                <form className="p-4 m-2 flex flex-row gap-4 items-center justify-center">
                    ...
                    />
                    <button
                        className={`w-fit p-3 px-16 bg-red-700 hover:bg-opacity-75 text-white rounded-md`}
                        type="submit"
                    ...
                    {
                        userGPTKey && <p className="text-white text-sm w-fit border border-white py-3 px-2 hover:bg-gray-500 cursor-pointer"
                            onClick={onKeyChange}
                        >
                            Go Back
                        </p>
