...
const GPTSuggestions = () => {
    ...
    return (
        <>
            ...
            {!isSearching && (
                <div className="flex flex-col px-16 gap-6 sm:mt-24 mt-16 justify-center items-center bg-black bg-gradient-to-l from-gray-700 ">
                    {showMessage && (
                        <h1 className="sm:text-2xl text-white">
