    ...
    return (
        <div className="flex justify-center">
            <div className="w-10/12 mt-32 bg-gray-500 rounded-lg bg-opacity-50">
                <form className="p-4 m-2 flex flex-row gap-4 items-center" onSubmit={(e) => e.preventDefault()}>
                    <input
                    ...
                    />
                    <button
                        className={`w-fit p-3 px-16 ${isSearching ? 'bg-gray-400' : 'bg-red-700 hover:bg-opacity-75'} text-white rounded-md`}
                        type="submit"
