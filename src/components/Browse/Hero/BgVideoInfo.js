...
const BgVideoInfo = ({ image_id, title, subtitle }) => {
    return (
        <div className="p-4 absolute top-1/2 w-fit lg:w-4/12 h-fit flex flex-col gap-4 lg:gap-10 lg:translate-x-14 -translate-y-1/2 z-10 text-white lg:p-8 rounded-lg bg-gray-800 bg-opacity-40 hover:bg-opacity-25 transition-all 0.5s ease-in-out">
            ...
            <div className='flex flex-col gap-2'>
                ...
                <p className='sm:text-sm text-[11px] text-justify w-3/4'>{subtitle}</p>
            </div>
